...
# (8, 6) is the coordinate in the example
...
def diagonal_rd(position: tuple, depth: int) -> List[int]:
    """Finds the right-down (rd) diagonally adjacent numbers from the position.
    
    Arguments:
        position {tuple} -- The x y coordinates of the number to begin searching from.
        depth {int} -- The number of adjacent numbers to search.
